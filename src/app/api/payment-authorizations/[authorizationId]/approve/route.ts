...
import { approveAuthorization } from "@/services/payment-authorization-service";
...
export async function PATCH(
    ...
    try {
        ...
        const result = await approveAuthorization(authorizationId, userId);

        return ApiResponse.success(
            result,
            "Payment authorization approved successfully"
        );
    } catch (error) {
